    ...
    >
      ...
      <aside class="admin-sidebar" [class.admin-sidebar--mobile-open]="mobileSidebarOpen()">
        <div class="admin-sidebar__header">
          <a routerLink="/admin/dashboard" (click)="closeMobileSidebar()" class="admin-sidebar__brand">
        ...
        <nav class="admin-sidebar__nav" aria-label="Menu administration">
          ...
          <a routerLink="/admin/dashboard" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
          ...
          <a routerLink="/admin/salons" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/tickets" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/boutique" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/categories" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/commandes" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/utilisateurs" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
          ...
          <a routerLink="/admin/settings" routerLinkActive="active" (click)="closeMobileSidebar()" class="admin-nav-item">
            <span class="admin-nav-item__icon">
